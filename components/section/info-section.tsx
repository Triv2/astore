...
return null;
  ...
  return (
    <div className="pb-10 h-screen flex flex-col gap-10 h-auto">
    ...
    <div className="grid sm:grid-cols-4 items-center p-5 justify-center gap-y-8 gap-x-8 px-4 sm:px-6 lg:px-8">
