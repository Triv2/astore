...
const TestimonialSection = async () => {
  ...
  return (
    <div className="flex flex-col items-center py-10 justify-center gap-y-8 gap-x-8 px-4 sm:px-6 lg:px-8 h-full bg-gradient-to-b from-slate-50 via-sky-200 to-slate-50">
