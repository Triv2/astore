...
const TestimonialSection = async () => {
  ...
  return (
    <div className="flex flex-col items-center py-10 justify-center gap-y-8 gap-x-8 px-4 sm:px-6 lg:px-8 h-full ">
      <h3 className="text-3xl font-bold p-10 rounded-md shadow-lg drop-shadow-lg">Testimonials</h3>
      <p className="p-10 rounded-md shadow-lg">Do not take our word for it, hear from our clients and customers!</p>
